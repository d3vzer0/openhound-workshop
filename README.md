...
|---|---|---|
| `notebooks/01-introduction.py` | Introduction and manual resource collection | [![Open in molab](https://molab.marimo.io/molab-shield.svg)](https://molab.marimo.io/github/d3vzer0/openhound-workshop/blob/master/notebooks/01-introduction.py)|
...
| `notebooks/06-agents.py` | Agentic development with OpenHound skills | [![Open in molab](https://molab.marimo.io/molab-shield.svg)](https://molab.marimo.io/github/d3vzer0/openhound-workshop/blob/master/notebooks/06-agents.py)|
